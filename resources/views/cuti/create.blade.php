                ...
                <div class="card-body p-4">
                    ...
                    <form method="POST" action="{{ route('cuti.store') }}" id="cutiForm" data-hmin="{{ $hMinCuti }}" enctype="multipart/form-data">
                        ...
                        <div class="row g-3 mb-4">
                            <div class="col-md-6">
                                <div class="d-flex align-items-center">
                                    <label class="form-label mb-0 me-2" style="width: 120px;">Leave Period</label>
                                    <span class="me-2">:</span>
                                    <input type="text" value="2024/2025" class="form-control bg-light" readonly>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="d-flex align-items-center">
                                    <label class="form-label mb-0 me-2">Total Leave day(s)</label>
                                    <span class="me-2">:</span>
                                    <input type="number" name="total_days" class="form-control" style="width: 100px;">
                                    <span class="ms-2 text-muted">Work/Calendar Days</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row g-3 mb-4">
                            <div class="col-md-6">
                                <div class="d-flex align-items-center">
                                    <label class="form-label mb-0 me-2" style="width: 120px;">On the date</label>
                                    <span class="me-2">:</span>
                            ...
                            <div class="col-md-6">
                                <div class="d-flex align-items-center">
                                    <label class="form-label mb-0 me-2">until</label>
                        ...
                        <div class="mb-4">
                            <div class="d-flex align-items-center">
                                <label class="form-label mb-0 me-2" style="width: 120px;">Holiday</label>
                                <span class="me-2">:</span>
                                <input type="text" name="holiday" class="form-control" placeholder="e.g., 09-10 November 2024">
                            </div>
                        </div>
                        ...
                        <div class="mb-4">
                            <div class="d-flex">
                                <label class="form-label mb-0 me-2" style="width: 120px;">Address on leave</label>
                                <span class="me-2">:</span>
                        ...
                        <div id="fileUploadFields" class="mb-4">
                            <div class="mb-3 d-none" id="suratDokterField">
                                <label class="form-label">Surat Dokter</label>
                                <input type="file" name="doctor_letter" class="form-control">
                                <div class="form-text">Upload surat keterangan dokter (PDF/JPG/PNG)</div>
                            </div>
                            <div class="mb-3 d-none" id="suratKeteranganField">
                                <label class="form-label">Surat Keterangan</label>
                                <input type="file" name="supporting_letter" class="form-control">
                                <div class="form-text">Upload surat keterangan dokter/bidan (PDF/JPG/PNG)</div>
                            </div>
                        </div>
