    ...
    <div class="container-fluid py-4">
        <div class="row">
            <div class="col-12">
                ...
                <div class="mb-4">
                    <button type="button" class="btn btn-primary" style="background-color: #7C3AED; border: none;" data-bs-toggle="modal" data-bs-target="#setupApp">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="list-group">
                                ...
                                <label class="list-group-item">
                                    <input class="form-check-input me-1" type="checkbox" name="days[]" value="{{ $day['value'] }}">
                                    {{ $day['label'] }}
                                </label>
                                @endforeach
                            </div>
                        </div>
                        <button type="submit" class="btn btn-primary w-100" style="background-color: #7C3AED; border: none;">
                            Simpan Pengaturan
                        </button>
                    </form>
                </div>
                ...
                <div class="modal-body">
                    <form id="eventForm">
                        ...
                        <div class="d-flex gap-2">
                            <button type="submit" class="btn btn-primary flex-grow-1" style="background-color: #7C3AED; border: none;">
                                Simpan
                            </button>
